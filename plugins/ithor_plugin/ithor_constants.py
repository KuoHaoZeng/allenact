...
MID_LEVEL_ARM_HEIGHT = 0.6
ARM_2_JNT_OFFSET_X = 0.3165426254272461
ARM_2_JNT_OFFSET_Y = (0.8999999761581421 + 0.44999998807907104) * MID_LEVEL_ARM_HEIGHT - 0.44999998807907104
# THOR BUG：HAND position is not working, use robot_arm_4_jnt location to approximate the distance for now. 
ARM_LENGTH = 0.6039555072784424
MOVE_HAND_CONSTANT = 0.05
