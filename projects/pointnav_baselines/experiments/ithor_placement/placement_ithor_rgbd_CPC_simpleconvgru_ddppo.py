...
from core.algorithms.onpolicy_sync.losses import PPO, YesNoImitation, CPC_loss
...
from projects.pointnav_baselines.models.point_nav_models import (
    PlacementCPCActorCriticSimpleConvRNN,
)
...
class PlacementThorRGBPPOExperimentConfig(PlacementThorBaseConfig):
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            pipeline_stages=[
                PipelineStage(loss_names=["ppo_loss", "yn_im_loss", "CPC_loss"], max_stage_steps=ppo_steps)
            ],
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PlacementCPCActorCriticSimpleConvRNN(
