...
from core.algorithms.onpolicy_sync.losses import PPO, NPM_Reg, YesNoImitation, CPC_loss
...
from projects.pointnav_baselines.models.point_nav_models import (
    PlacementCPCKeyPointsVisualNPMActorCriticSimpleConvRNN,
)
...
class PlacementNaviThorRGBPPOExperimentConfig(PlacementThorBaseConfig):
    ...
    @classmethod
    def tag(cls):
        return "Placement-iTHOR-RGBD-CPC-KeyPoints-wVisual-SimpleConv-DDPPO"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "CPC_loss": CPC_loss(positive_uuid="logit_positive",
        ...
        gamma=gamma,
            ...
            pipeline_stages=[
                PipelineStage(loss_names=["ppo_loss", "npm_loss", "yn_im_loss", "CPC_loss"], max_stage_steps=ppo_steps)
            ],
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PlacementCPCKeyPointsVisualNPMActorCriticSimpleConvRNN(
