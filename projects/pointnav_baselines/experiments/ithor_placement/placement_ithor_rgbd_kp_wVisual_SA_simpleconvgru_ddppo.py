...
from projects.pointnav_baselines.models.point_nav_models import (
    PlacementKeyPointsVisualNPMSAActorCriticSimpleConvRNN,
)
...
class PlacementNaviThorRGBPPOExperimentConfig(PlacementThorBaseConfig):
    ...
    @classmethod
    def tag(cls):
        return "Placement-iTHOR-RGBD-KeyPoints-wVisual-SA-SimpleConv-DDPPO"
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PlacementKeyPointsVisualNPMSAActorCriticSimpleConvRNN(
