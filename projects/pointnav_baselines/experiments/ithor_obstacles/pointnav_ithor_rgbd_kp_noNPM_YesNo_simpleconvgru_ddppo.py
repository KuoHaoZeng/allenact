...
from projects.pointnav_baselines.models.point_nav_models import (
    PointNavKeyPointsNPMActorCriticSimpleConvRNN,
)
...
class PointNaviThorRGBPPOExperimentConfig(PointNaviThorBaseConfig):
    ...
    def __init__(self):
        ...
        self.SENSORS = [
            ...
            ExpertActionSensor(
                nactions=len(PointNavObstaclesTask.class_action_names()),
                uuid="expert_action",
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-iTHOR-RGBD-KeyPoints-noNPM-YesNo-SimpleConv-DDPPO"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={
                ...
                "yn_im_loss": YesNoImitation(yes_action_index=PointNavObstaclesTask.class_action_names().index(END)),
            },
            gamma=gamma,
            use_gae=use_gae,
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PointNavKeyPointsNPMActorCriticSimpleConvRNN(
