...
from core.algorithms.onpolicy_sync.losses import PPO, CPC_loss
...
from projects.pointnav_baselines.models.point_nav_models import (
    PointNavCPCActorCriticSimpleConvRNN,
)
...
class PointNaviThorRGBPPOExperimentConfig(PointNaviThorBaseConfig):
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-iTHOR-RGBD-CPC-SimpleConv-DDPPO"
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            pipeline_stages=[
                PipelineStage(loss_names=["ppo_loss", "CPC_loss"], max_stage_steps=ppo_steps)
            ],
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PointNavCPCActorCriticSimpleConvRNN(
