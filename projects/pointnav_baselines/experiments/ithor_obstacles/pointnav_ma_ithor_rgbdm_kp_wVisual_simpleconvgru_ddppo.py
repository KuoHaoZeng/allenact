...
from projects.pointnav_baselines.models.point_nav_models import (
    PointNavMAKeyPointsVisualNPMActorCriticSimpleConvRNN,
)
...
class PointNaviThorRGBPPOExperimentConfig(PointNaviThorBaseConfig):
    ...
    @classmethod
    def tag(cls):
        return "Pointnav-ma-iTHOR-RGBDM-KeyPoints-wVisual-SimpleConv-DDPPO"
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PointNavMAKeyPointsVisualNPMActorCriticSimpleConvRNN(
