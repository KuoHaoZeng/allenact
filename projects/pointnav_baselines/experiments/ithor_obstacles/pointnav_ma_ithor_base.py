...
from plugins.ithor_plugin.ithor_task_samplers import PointNavObstaclesMissingActionDatasetTaskSampler
...
class PointNaviThorBaseConfig(ObjectNavBaseConfig, ABC):
    ...
    def __init__(self):
        ...
        self.TRAIN_DATASET_DIR = os.path.join(
            ABS_PATH_OF_TOP_LEVEL_DIR, "datasets/ithor-pointnav-obstacles-missing-action_1episode/train"
        )
        self.VAL_DATASET_DIR = os.path.join(
            ABS_PATH_OF_TOP_LEVEL_DIR, "datasets/ithor-pointnav-obstacles-missing-action_1episode/test"
        )
    ...
    def make_sampler_fn(cls, **kwargs) -> TaskSampler:
        return PointNavObstaclesMissingActionDatasetTaskSampler(**kwargs)
    ...
    def _get_sampler_args_for_scene_split(
        ...
        return {
            ...
            "action_space": gym.spaces.Discrete(
                len(PointNavObstaclesMissingActionTask.class_action_names())
            ),
