...
from core.algorithms.onpolicy_sync.losses import PPO, MA_loss, CPC_MA_loss
...
from projects.pointnav_baselines.models.point_nav_models import (
    PointNavMAInternalCPCIndexActorCriticSimpleConvRNN,
)
...
class PointNaviThorRGBPPOExperimentConfig(PointNaviThorBaseConfig):
    ...
    def training_pipeline(cls, **kwargs):
        ...
        return TrainingPipeline(
            ...
            named_losses={"ppo_loss": PPO(**PPOConfig),
                          "MA_loss": MA_loss(internal_uuid="internal_output_negative",
    ...
    def create_model(cls, **kwargs) -> nn.Module:
        return PointNavMAInternalCPCIndexActorCriticSimpleConvRNN(
