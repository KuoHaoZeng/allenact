...
from projects.dm_minigrid.minigrid_ma import MiniGridMAExperimentConfig


class MiniGridMAMARExperimentConfig(MiniGridMAExperimentConfig):
    def __init__(self):
        super().__init__()
